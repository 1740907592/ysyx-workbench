...
static void decode_operand(Decode *s, int *rd, word_t *src1, word_t *src2, word_t *imm, int type) {
  ...
  *rd = (((i) >> (7)) & ((1ull << ((11) - (7) + 1)) - 1));
  switch (type) {
    case TYPE_I:
    {
      do { *src1 = (cpu.gpr[check_reg_idx(rs1)]); } while (0);
      do { *imm = ({ struct { int64_t n : 12; } __x = { .n = (((i) >> (20)) & ((1ull << ((31) - (20) + 1)) - 1)) }; (uint64_t)__x.n; });} while(0);
      break;
    }
    ...
    case TYPE_R: {
      do { *src1 = (cpu.gpr[check_reg_idx(rs1)]); } while (0);
      do { *src2 = (cpu.gpr[check_reg_idx(rs2)]); } while (0);
      ;
      break;
    }
    case TYPE_SB: {
    ...
    case TYPE_UJ: {
      do { *imm = (({ struct { int64_t n : 1; } __x = { .n = (((i) >> (31)) & ((1ull << ((31) - (31) + 1)) - 1)) }; (uint64_t)__x.n; }) << 19) | ((((i) >> (12)) & ((1ull << ((19) - (12) + 1)) - 1)) << 11) | ((((i) >> (20)) & ((1ull << ((20) - (20) + 1)) - 1)) << 10) | ((((i) >> (21)) & ((1ull << ((30) - (21) + 1)) - 1)) << 0); *imm = ({ struct { int64_t n : 20; } __x = { .n = *imm }; (uint64_t)__x.n; }) << 1; } while (0);
      break;
    }
    case TYPE_N: break;
    default: do { if (!(0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "unsupported type = %d" "\33[0m" "\n", type)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/isa/riscv32/inst.c", 85, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
  }
}
static int decode_exec(Decode *s) {
  ...
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 001 ????? 0010011", (sizeof("0000000 ????? ????? 001 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 << imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 010 ????? 0010011", (sizeof("??????? ????? ????? 010 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (src1 < imm) ? 1 : 0 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 011 ????? 0010011", (sizeof("??????? ????? ????? 011 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = ((uint32_t)src1 < imm) ? 1 : 0 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 100 ????? 0010011", (sizeof("??????? ????? ????? 100 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 ^ imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 101 ????? 0010011", (sizeof("0000000 ????? ????? 101 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = (uint32_t)src1 >> imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0100000 ????? ????? 101 ????? 0010011", (sizeof("0100000 ????? ????? 101 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 >> imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 110 ????? 0010011", (sizeof("??????? ????? ????? 110 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 | imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 111 ????? 0010011", (sizeof("??????? ????? ????? 111 ????? 0010011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = src1 & imm ; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? 00000 11", (sizeof("??????? ????? ????? 000 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = vaddr_read(src1 + imm, 1) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 001 ????? 00000 11", (sizeof("??????? ????? ????? 001 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = vaddr_read(src1 + imm, 2) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 010 ????? 00000 11", (sizeof("??????? ????? ????? 010 ????? 00000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = vaddr_read(src1 + imm, 4) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? 1100111", (sizeof("??????? ????? ????? 000 ????? 1100111") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_I); (cpu.gpr[check_reg_idx(rd)]) = s->pc + 4, s->dnpc = src1 + imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 000 ????? 0110011", (sizeof("0000000 ????? ????? 000 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 + src2 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000001 ????? ????? 000 ????? 0110011", (sizeof("0000001 ????? ????? 000 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 * src2 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0100000 ????? ????? 000 ????? 0110011", (sizeof("0100000 ????? ????? 000 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 - src2 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 001 ????? 0110011", (sizeof("0000000 ????? ????? 001 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 << src2 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 010 ????? 0110011", (sizeof("0000000 ????? ????? 010 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = (src1 < src2) ? 1 : 0 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("0000000 ????? ????? 100 ????? 0110011", (sizeof("0000000 ????? ????? 100 ????? 0110011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_R); (cpu.gpr[check_reg_idx(rd)]) = src1 ^ src2 ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 1101111", (sizeof("??????? ????? ????? ??? ????? 1101111") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_UJ); (cpu.gpr[check_reg_idx(rd)]) = s->pc + 4, s->dnpc = s->pc + imm ; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 001 ????? 01000 11", (sizeof("??????? ????? ????? 001 ????? 01000 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_S); vaddr_write(src1 + imm, 2, src2) ; }; goto *(__instpat_end); } } while (0);
  ...
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? ??? ????? 01101 11", (sizeof("??????? ????? ????? ??? ????? 01101 11") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_U); (cpu.gpr[check_reg_idx(rd)]) = imm ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 000 ????? 1100011", (sizeof("??????? ????? ????? 000 ????? 1100011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_SB); (src1 == src2 ? s->dnpc = s->pc + imm : s->dnpc) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 001 ????? 1100011", (sizeof("??????? ????? ????? 001 ????? 1100011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_SB); (src1 != src2 ? s->dnpc = s->pc + imm : s->dnpc) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 100 ????? 1100011", (sizeof("??????? ????? ????? 100 ????? 1100011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_SB); (src1 < src2 ? s->dnpc = s->pc + imm : s->dnpc) ; }; goto *(__instpat_end); } } while (0);
  do { uint64_t key, mask, shift; pattern_decode("??????? ????? ????? 101 ????? 1100011", (sizeof("??????? ????? ????? 101 ????? 1100011") - 1), &key, &mask, &shift); if ((((uint64_t)((s)->isa.inst) >> shift) & mask) == key) { { int rd = 0; word_t src1 = 0, src2 = 0, imm = 0; decode_operand(s, &rd, &src1, &src2, &imm, TYPE_SB); (src1 > src2 ? s->dnpc = s->pc + imm : s->dnpc) ; }; goto *(__instpat_end); } } while (0);
